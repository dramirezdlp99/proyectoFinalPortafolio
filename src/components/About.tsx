      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <div className="w-full lg:w-1/2 relative pr-0 lg:pr-8 mb-8 lg:mb-0">
            ...
            {/* ✅ Botones de navegación - AMBOS PARCIALMENTE SOBRE LA IMAGEN */}
            <button 
              onClick={scrollPrev}
            ...
            <button 
              onClick={scrollNext}
              className={`absolute top-1/2 right-4 lg:right-12 transform -translate-y-1/2 p-2 rounded-full z-10 transition-all ${navButtonClasses}`}
              aria-label="Next"
            >
